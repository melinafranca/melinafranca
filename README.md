...
Minha especialidade é conectar exigências regulatórias a rotinas práticas, garantindo rastreabilidade e eficiência. 
...
| :--- | :--- | :--- |
| **Projeto ARIA** | Solução em IA Generativa focada na análise de documentos regulatórios (2º lugar no Hackathon Gen.AI - Talento Tech 3.0). | `AWS Bedrock`, `AWS Step Functions`, `LLMs`, `RAG`, `Parameter Store` |
| **Chatbot Inclusivo** | Assistente virtual para e-commerce focado em acessibilidade e facilitação da jornada de compra. | `DynamoDB`, `AWS Lambda`, `Amazon Lex`, `Amazon S3`, `AWS X-Ray` |
| **Análise Epidemiológica: COVID-19** | Estudo de casos e análise da evolução da pandemia de Covid-19 em Viçosa-MG (2020-2021)  | `Análise de Dados`, `Excel`, `Estatística descritiva` |

---

## 🤝 Conecte-se comigo

Será um prazer conversar sobre Cloud, migração de carreira, tecnologias e séries rs :D

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/melina-franca)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mvmelina.franca@gmail.com)
